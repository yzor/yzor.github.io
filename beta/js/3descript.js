  ...
  $.when.apply($, deferreds).done(function () { //дождатся окончания ajax
    $.each(QWE.PIX, function (i) { //перебор списка рядов
      ...
      if (i == 1&&QWE.nymberType == 2) {
        D += "<p class='row'><b>2-й и все чётные (изнаночные) ряды:</b> <span class='box'>петли</span> хреначить по рисунку. <span class='box'>Накид</span> накидывать сверху.</p>";
      }
          ...
          $.each(v, function (I) { // 2 перебор only закрашеных клеток
            ...
            if (isRap(i, v[I]) && !isRap(i, v[I + 1])) {
              ...
              spase = "<span class='star l'>*</span>" + //💩
                " повторять&nbspот&nbsp<span class='star l'>*</span>&nbspдо&nbsp<span class='star l'>*</span>";
